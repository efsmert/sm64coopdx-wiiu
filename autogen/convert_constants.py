...
def build_to_c(built_files):
    ...
    # Source files
    # Marker is used by the Wii U loader to split heavy autogenerated
    # constants into smaller execution chunks without changing prelude
    # script semantics.
    txt += '\n-- __SM64COOPDX_AUTOGEN_CONSTANTS_BEGIN__\n' + built_files
