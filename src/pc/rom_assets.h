...
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_name, ROM_ASSET_VTX, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
...
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_name, ROM_ASSET_TEXTURE, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}

#define ROM_ASSET_LOAD_SAMPLE(_name, _ptr, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize) \
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_ptr, ROM_ASSET_SAMPLE, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
...
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_name, ROM_ASSET_COLLISION, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
...
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_name, ROM_ASSET_ANIM, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
...
static u16 _name[(_segmentedSize) / 2] = { 0 }; \
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_ptr, ROM_ASSET_ANIM, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
...
__attribute__((constructor)) static void _ptr ## _rom_assets_queue () { \
    rom_assets_queue(_ptr, ROM_ASSET_DIALOG, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}

#define ROM_ASSET_LOAD_DEMO(_name, _ptr, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize) \
__attribute__((constructor)) static void _name ## _rom_assets_queue () { \
    rom_assets_queue(_ptr, ROM_ASSET_DEMO, _physicalAddress, _physicalSize, _segmentedAddress, _segmentedSize, __FILE__, __LINE__); \
}
